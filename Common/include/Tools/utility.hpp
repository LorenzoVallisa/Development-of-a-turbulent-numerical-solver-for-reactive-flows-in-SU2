...
#include <set>
#include <map>
#include "../Framework/su2_assert.hpp"
...
namespace Utility {
  ...
  */
  ...
  /*!
    * \brief Read extra terms to compute correctly backward and forward rate
    * \param[in] line - line of the reaction
    * \param[in] idx_reac - current index of reaction
    * \param[in] is_for - true is we are considering the forward side
    * \param[in] map_names - map with all species name
    * \param[out] stoich_coeff - matrix of stechiometric coefficients
    * \param[out] stoich_coeff_exp_reac - matrix of stechiometric coefficients at the exponent of concetration
  */
